...
const extractInteractionModes = (visualCharacteristicsNode : any) : IInteractionMode[] | any => {
...
const extractWindowTemplates = (visualCharacteristicsNode : any) : IDisplayWindowTemplate[] | any => {
    for (let jsonNode of visualCharacteristicsNode) {
...
const extractDisplay = (visualCharacteristicsNode : any) : IDeviceDisplay | any => {
    for (let jsonNode of visualCharacteristicsNode) {
...
const extractVideo = (visualCharacteristicsNode : any) : IVideo | any => {
    for (let jsonNode of visualCharacteristicsNode) {
...
const createDeviceAppConfig = (
    ...
    for (let windowConfig of appConfig.windows as IAPLWindowConfig[]) {
        let disallowVideo : boolean | any;
        let mode : DeviceMode = 'HUB';
        let windowTemplate : IDisplayWindowTemplate | any;
...
const createViewportCharacteristicsFromWindowTemplate = (
    ...
    if (windowTemplate) {
        let windowSizeConfiguration : IDisplayWindowSize | any;
