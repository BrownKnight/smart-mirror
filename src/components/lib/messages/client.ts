...
import { ILogger, LoggerFactory } from '../utils/logger';
...
export class Client implements IClient {
    ...
    protected timerId : number | any;
    protected backoff : number | any;
    protected url : string;
    protected ws : WebSocket | any;
    ...
    protected wsOnMessage(event : MessageEvent) {
        ...
        let message : IBaseInboundMessage | any = undefined;
        try {
